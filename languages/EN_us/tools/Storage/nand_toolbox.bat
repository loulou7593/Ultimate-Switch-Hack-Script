...
echo 4: Enable or disable auto-RCM on a BOOT0 partition of a console or of a dumped file?
echo 5: Join a splitted dump of a rawnand, for example a dump made via Hekate on a FAT32 formated SD?
echo 6: Split a rawnand dump?
echo 7: Create a file from a complete nand dump that you can use to flash a partition on a SD for emunand?
echo 8: Extract a complete dump from an emunand partition created/dumped file?
echo 9: Decrypt a dump or a partition of a rawnand?
echo 10: Encrypt a dump or a partition of a rawnand?
