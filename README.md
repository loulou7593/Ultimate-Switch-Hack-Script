...
La préparation d'une SD permet de préparer celle-ci jusqu'à Atmosphere 0.11.1, SX OS 2.9.5 beta (pour le reste voir les changelogs) et donc le hack est pris en charge jusqu'au firmware 10.0.1 et inférieurs pour les consoles non patchées, pour les consoles patchées Cafeine prend en charge les consoles sur le firmware 4.1.0 et inférieur. Pour des raisons personnelles ce script sera bien moins mis à jour par moi-même pendant une période non définie.
