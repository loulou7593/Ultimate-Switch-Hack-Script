...
<li>Mise à jour de Ldn_mitm et du homebrew Ldnmitm_config en version 1.2.0. Maintenant, ce module est configurable dans les profils de modules optionnels et n'est plus disponible en tant que fichier kip.</li>
</ul>
...
<ul>
<li>Le homebrew Payload_launcher est maintenant copié d'une manière un peu différente, du coup une grande partie des payloads qu'il contenait par défaut a été supprimée car la copie de ceux-ci se décidera selon les choix faits durant la préparation de la SD.</li>
<li>Mise à jour d'Atmosphere vers la dernière version "Master" du github, compilé par moi-même.</li>
</ul>
<h2>V122</h2>
<ul>
...
<ul>
<li>Intégration du homebrew <a target="_blank" href="https://github.com/suchmememanyskill/Payload_Launcher/releases">Payload_Launcher</a> dans les homebrews optionnels, les autres homebrews permettant cette fonctionnalité ont été retirés des packs spécifiques.</li>
</ul>
...
<li>Mise à jour de Atmosphere et de ReiNX vers la dernière version "Master" des Github associés, respectivement pour les packs Atmosphere et ReiNX.</li>
...
<ul>
<li>Mise à jour de EdiZon en dernière version "Master" du Github, compilé par moi-même.</li>
<li>Ajout d'un nouveau jeu dans les configurations de scripts de modification de sauvegardes de EdiZon.</li>
</ul>
...
<h2>V89</h2>
<ul>
<li>ReiNX a été ré implémenté correctement avec une version fonctionnel pour les firmwares 6.2.0 et inférieur. Le HBL est maintenant géré via le fichier "hbl.nsp" plutôt que via le title id.</li>
</ul>
<h2>V87</h2>
<ul>
...
<li>Ajout du module Sys-clk dans tous les packs sauf SX OS et émulateurs.</li>
<li>Ajout du homebrew Incognito pour tous les packs.</li>
<li>Remise en place de Tinfoil de Adube suite à des retours problématiques avec Goldleaf, Goldleaf est cependant conservé.</li>
...
<li>Le fichier du payload à rebooter avec le homebrew Reboot_to_payload lié aux packs Kosmos et Atmosphere n'est plus inclut dans les packs, la version 2.00.13 du script copie Hekate directement en se basant sur la version incluse dans les packs, ceci permet d'éliminer des doublons inutiles de fichiers.</li>
</ul>
<h2>V85</h2>
<ul>
