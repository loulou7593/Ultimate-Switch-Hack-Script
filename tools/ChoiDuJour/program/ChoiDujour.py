...
try:
    ...
    fsPatches = {}
    fsPatchesJsonBytes = fetch_url_bytes('https://raw.githubusercontent.com/shadow2560/Ultimate-Switch-Hack-Script/master/tools/ChoiDuJour/firmware/fs_patches.json')
    ...
    jayson = {}
    try:
        patchesJsonUrl = 'https://raw.githubusercontent.com/shadow2560/Ultimate-Switch-Hack-Script/master/tools/ChoiDuJour/firmware/'+versionHash
        if firmwareIsExFAT:
